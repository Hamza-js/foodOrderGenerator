      ...
      <div className="innerContainerWhite flex flex-col justify-between">
        ...
        <div className="px-5 mt-[75px] sm:mt-[55px]">
          ...
          <QRCode
            ...
            viewBox={`0 0 256 256`}
            className="sm:h-[100px] sm:w-[100px] sm:mt-[5px] h-[168px]"
          />
          ...
          <div className="rounded-xl border border-gray-400-500 mt-[25px] sm:my-[0px] mb-[25px]">
            ...
            <div className="flex flex-col rounded-xl bg-[#7264E4] text-white justify-between sm:items-center pb-[30px] sm:pb-[10px] mt-[8px] sm:mt-[6px] px-3 w-full">
